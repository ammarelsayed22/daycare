                          ...
                          <table class='attendance-table'>
                              ...
                              <tbody>
                                ...
                                <tr>    @foreach ( $dads as $dad )
                                    ...
                                    <td> <a href="{{ route('teacher.dads.edit', $dad->id) }}" class="btn btn-sm btn-success">Edit</a></td>
                                    <td>  <form action="{{ route('teacher.dads.destroy', $dad->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
