  ...
  <div class='home'>
    <div class="landing">
        <div class="container">
            <div class="text">
              ...
              <h3>Baby Daycare & Kindergarden
               </h3>
              <h1>Welcome Teacher :{{  Auth::guard('teacher')->user()->name; }}</h1>
              <div class='button'>
    ...
    <section class="pt-2 parent row w-100 m-auto">
        ...
        <div class="col-sm-5 col-md-5">
          ...
          <div class="msg">
            <p>{{ date('s', strtotime($comment->date)) }}</p>
    ...
    <section class="gallary text-center">
            ...
            <div class="btn">
                <div class='button'>
                    <a href="{{ route('teacher.galleries.index') }}" class="btn">View More</a>
                 </div>
            </div>
