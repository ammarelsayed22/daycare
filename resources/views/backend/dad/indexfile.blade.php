...
@foreach($files as $file)
        <div class='books col-lg-6 col-sm-12 m-auto my-5'>
           ...
           <div class='book'>
                ...
                <h4>{{ $file->name }}</h4>
                <div class="buttons">
                    <a href="{{ route('dad.file.show', ['filename' => $file->name]) }}" class="form-btn up">View File</a>
                    <a href="{{ route('dad.file.download', ['filename' => $file->name]) }}" download="{{ $file->name }}" class="form-btn up">Download <span><i class="fa-solid fa-file-pdf"></i></span></a>
                </div>
          </div>
